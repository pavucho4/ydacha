      ...
      {isPopular ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {Array.isArray(products) && products.length > 0 ? (
            ...
            <div>Нет популярных товаров</div>
          )}
        </div>
      ) : (
        categories.map(category => (
          <div key={category} className="mb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {Array.isArray(products) && products.filter(product => product.category === category).length > 0 ? (
                products
                ...
                <div>Нет товаров в категории {category}</div>
              )}
            </div>
          </div>
        ))
